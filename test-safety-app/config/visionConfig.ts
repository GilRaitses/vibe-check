...
export const VISION_CONFIG: VisionConfig = {
  ...
  prompt: `Analyze this traffic camera image and return ONLY a JSON object with encoded values (0-4) for each variable at each position. Use these exact keys:
...
Values: 0=none, 1=few/light/low/minimal, 2=some/moderate/basic, 3=many/heavy/high/good, 4=crowded/jammed/intense/excellent
